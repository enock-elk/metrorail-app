const CACHE_NAME = 'metrorail-next-train-v4.12'; // Bumped version to force update
const ASSETS_TO_CACHE = [
  ...
  './images/land-404.jpg', // Added landscape 404 image
  './images/port-404.jpg'  // Added portrait 404 image
];
